...
export type TranslationKey =
  ...
  | 'scanner.title' | 'scanner.subtitle' | 'scanner.permissionTitle' | 'scanner.permissionSubtitle' | 'scanner.manualTitle' | 'scanner.manualSubtitle' | 'scanner.reading' | 'scanner.waiting' | 'scanner.processing' | 'scanner.tryAgain' | 'scanner.invalidBarcode' | 'scanner.manualPlaceholder'
